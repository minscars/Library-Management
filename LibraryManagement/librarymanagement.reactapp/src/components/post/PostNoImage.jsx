...
const post = () => {
  return (
    <div className="mb-2 mt-2 flex w-full items-center justify-between rounded-2xl bg-white p-3 shadow-3xl shadow-shadow-500 dark:!bg-navy-700 dark:shadow-none">
      <div className="flex items-center">
        ...
        <div className="ml-4">
          <p className="text-xl font-bold text-navy-700 dark:text-white">
            Title for a post without image
          </p>
